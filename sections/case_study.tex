...
\textcolor{red}{[aqui é bom fazer uma menção honrosa para essa implementação promissora do signal pela Matrix, o olm é a implementação deles do protocolo signal como ele é, mas eles adicionam ao protocolo mais propriedades com o megolm, que é]}
