...
No cenário atual, a riqueza dos metadados permite a entrega de informações táticas fundamentais. A Meta pode fornecer a teia de contatos do investigado (volume e registros de mensagens), dados de grupos (informações de todos os membros associados) e vínculos sociais com perfis do Facebook e Instagram. Consequentemente, mesmo sem acesso ao teor das conversas, as autoridades conseguem mapear de forma cristalina a rede de relacionamentos de uma investigação.
