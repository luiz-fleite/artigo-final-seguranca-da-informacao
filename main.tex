...
\end{document}
Arquivo .bib (Referências Bibliográficas)

Crie um arquivo chamado sbc-template.bib dentro da pasta bib/ (ou onde seu projeto estiver configurado para ler as referências) e cole o seguinte conteúdo. Estas são as referências reais e formatadas corretamente.
...
@misc{signal_docs,
  ...
  hownote = {Disponível em: \url{https://signal.org/docs/}. Acesso em: 12 jun. 2024},
  year = {2024},
...
@misc{whatsapp_whitepaper,
  title = {{WhatsApp Encryption Overview - Technical Whitepaper}},
  author = {{WhatsApp Inc.}},
  hownote = {Disponível em: \url{https://www.whatsapp.com/security/WhatsApp-Security-Whitepaper.pdf}},
  year = {2023},
  note = {Acesso em: 12 jun. 2024}
}

@misc{whatsapp_privacy,
  title = {{WhatsApp Privacy Policy}},
  author = {{WhatsApp Inc.}},
  hownote = {Disponível em: \url{https://www.whatsapp.com/legal/privacy-policy}},
  year = {2024},
  note = {Acesso em: 12 jun. 2024}
}

@article{marlinspike2016whatsapp,
...
Como você está usando referências bibliográficas separadas, o processo de compilação no LaTeX geralmente segue esta ordem (se você estiver usando linha de comando ou alguns editores manuais):

pdflatex seu_arquivo.tex (Gera o aux)

bibtex seu_arquivo (Gera as referências baseadas no .bib)

pdflatex seu_arquivo.tex (Vincula as referências)

pdflatex seu_arquivo.tex (Finaliza a formatação)

Se estiver usando Overleaf, basta clicar em "Recompile". Certifique-se de que a estrutura de pastas (styles/ e bib/) está correta conforme declarado no código.